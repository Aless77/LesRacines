...
public class PlayerAttack : MonoBehaviour
{
    ...
    void Attack()
    {
        RaycastHit hit; // Variable pour stocker les informations de l'objet touch� par le RayCast
    ...
    public void AttackFinish() // Fonction appel�e � la fin de l'animation d'attaque � l'aide d'un animation event
    {
        isAttacking = false;
